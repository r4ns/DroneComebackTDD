...
public class DroneTest {
	...
	@Test
	public void test_BoundariesMoveUp() {
	...
	@Test
	public void test_BoundariesMoveDown() {
		Drone drone = new Drone(20, 10, 20);
	...
	@Test
	public void test_BoundariesMoveLeft() {
		Drone drone = new Drone(20, 10, 20);
		
		String expected = "Drone: (19, 10, 20)";
	...
	public void test_InitialMoveRight() {
		...
		String expected = "Drone: (1, 0, 0)";
		
		assertEquals(expected, drone.moveRight());
	}
	@Test
	public void test_BoundariesMoveRight() {
		Drone drone = new Drone(20, 10, 20);
		
		String expected = "Drone: (21, 10, 20)";
	...
	public void test_InitialMoveBack() {
		...
		String expected = "Drone: (0, 0, 1)";
		
		assertEquals(expected, drone.moveBack());
	}
	@Test
	public void test_BoundariesMoveBack() {
		Drone drone = new Drone(20, 10, 20);
		
		String expected = "Drone: (20, 10, 21)";
	...
	@Test
	public void test_BoundariesMoveForth() {
		Drone drone = new Drone(20, 10, 20);
		
		String expected = "Drone: (20, 10, 19)";
